...
1. Retrieval verification should distinguish relevance from query-conditioned
   admissibility.
2. Stored, retrieved, exposed, and used are different observable events and should
...
6. Exposure-to-use measurements motivate verification, but the observed association
